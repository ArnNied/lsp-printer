...
<div class="centered p-8 bg-white rounded space-y-4">
    ...
    <form action="<?= BASE_SYSTEM ?>auth/login.php" method="POST" class="flex flex-col space-y-4">
        ...
        <div class="flex flex-col">
            <button type="submit" name="user_login" class="p-2 bg-blue-500 hover:bg-blue-600 focus:bg-blue-700 font-semibold text-white">LOGIN</button>        
        </div>
    </form>
</div>
